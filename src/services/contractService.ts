 ...
 */
export function renderContractHtml(booking: BookingWithPeople): string {
  const ownerName = displayName(booking.owner_full_name, booking.owner_first_name);
  const renterName = displayName(booking.renter_full_name, booking.renter_first_name);
